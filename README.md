...
🖼️ JavaFX Desktop Client	Standalone desktop dashboard built with JavaFX 21
...
Java 17+
Maven 3.6+
JavaFX 21.0.2 (pulled in automatically by Maven via pom.xml)
...
# 4. Run the application (Spring Boot web app)
mvn spring-boot:run

# Or run the JavaFX desktop client instead
mvn javafx:run
...
Get your free API key at openweathermap.org — the free tier is more than enough to run this project.
