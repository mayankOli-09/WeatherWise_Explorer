...
public class DatabaseManager 
{
    ...
    private void loadData() 
    {
        ...
        // ── CITIES ──────────────────────────────────────────
        cityMap.put("dehradun",  new CityInfo("dehradun",  "Dehradun",  "India (Uttarakhand)", "Capital of Uttarakhand in the Doon Valley. Gateway to Mussoorie and Rishikesh."));
        
        cityMap.put("mussoorie", new CityInfo("mussoorie", "Mussoorie", "India (Uttarakhand)", "Queen of Hills at 2000m altitude. Famous for scenic views and colonial charm."));
        
        cityMap.put("rishikesh", new CityInfo("rishikesh", "Rishikesh", "India (Uttarakhand)", "Yoga Capital of the World. Sits on the banks of the holy Ganga river."));
        
        cityMap.put("haridwar",  new CityInfo("haridwar",  "Haridwar",  "India (Uttarakhand)", "One of the seven holiest Hindu cities. Famous for Ganga Aarti at Har Ki Pauri."));
    ...
    public List<PlaceInfo> getPlaces(String cityKey) 
    {
        ...
        for (PlaceInfo p : allPlaces)
            if (p.getCityKey().equals(key)) result.add(p);
        return result;
    }
